...
export const AuthField: React.FC<AuthFieldProps> = ({
  ...
  <View className="w-full">
    ...
    >
      {prefix ? <Text className="mr-1 font-sans-medium text-[14px] text-ink-mute">{prefix}</Text> : null}
      <TextInput
    ...
    {showAvailable ? <Text className="mt-1.5 font-mono-medium text-[9px] text-green">disponível</Text> : null}
  </View>
);
