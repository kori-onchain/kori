...
import { Modal, View, StyleSheet, SafeAreaView, Platform, TouchableOpacity } from 'react-native';
import { PaymentIntent, PaymentScreen, PaymentRecipient } from '../../types/payment';
