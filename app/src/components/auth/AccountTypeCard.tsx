...
import { AccountType } from "@type/auth";
        ...
        <View className="min-h-[78px] flex-row items-center p-3.5">
          ...
          <View className="mx-3 flex-1">
            ...
            <Text className="mt-0.5 font-sans text-[11px] leading-4 text-ink-dim">
              {isPJ
                ? "Vender produtos físicos ou digitais e receber."
                : "Transferências, dia a dia e privacidade."}
            </Text>
          </View>
          <View
            className={`h-5 w-5 items-center justify-center rounded-full border ${selected ? "border-ink" : "border-ink-mute"}`}
          >
            {selected ? (
